...
This is the PyTorch source code for the WiTeacher paper. 
The code runs on Python 3. 
Install the dependencies and prepare the datasets with the following commands:


WiTeacher is activity recognition for cross-domain scenarios using WiFi CSI.
...
## WiTeacher Overview
 ...
 In this framework, we designed a adaptive
